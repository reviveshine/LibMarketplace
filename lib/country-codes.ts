...
/**
 * Comprehensive list of countries with their codes, dial codes, and flags
 * Priority countries are shown first in dropdowns
 */
export const COUNTRIES: CountryData[] = [
  // Priority countries (Liberia first, then common international)
  { code: 'LR', name: 'Liberia', dialCode: '+231', flag: '🇱🇷', priority: 1 },
  { code: 'US', name: 'United States', dialCode: '+1', flag: '🇺🇸', priority: 2 },
  { code: 'GB', name: 'United Kingdom', dialCode: '+44', flag: '🇬🇧', priority: 3 },
  { code: 'CA', name: 'Canada', dialCode: '+1', flag: '🇨🇦', priority: 4 },
  { code: 'NG', name: 'Nigeria', dialCode: '+234', flag: '🇳🇬', priority: 5 },
  { code: 'GH', name: 'Ghana', dialCode: '+233', flag: '🇬🇭', priority: 6 },
...
/**
 * Get countries sorted by priority (priority countries first, then alphabetical)
 */
export function getSortedCountries(): CountryData[] {
...
/**
 * Get African countries for regional filtering
 */
export function getAfricanCountries(): CountryData[] {
  const africanCodes = ['DZ', 'AO', 'BJ', 'BW', 'BF', 'BI', 'CM', 'CV', 'CF', 'TD', 'KM', 'CD', 'CG', 'DJ', 'EG', 'GQ', 'ER', 'ET', 'GA', 'GM', 'GH', 'GN', 'GW', 'CI', 'KE', 'LS', 'LR', 'LY', 'MG', 'MW', 'ML', 'MR', 'MU', 'MA', 'MZ', 'NA', 'NE', 'NG', 'RW', 'ST', 'SN', 'SC', 'SL', 'SO', 'ZA', 'SS', 'SD', 'SZ', 'TZ', 'TG', 'TN', 'UG', 'ZM', 'ZW']
  
  return COUNTRIES.filter(country => africanCodes.includes(country.code))
}